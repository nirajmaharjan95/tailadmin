...
const TaskCard = (props: TaskCardProps) => {
    const { id, task_title, due_date, tags, setShowModal, setEditTaskId, deleteTask } = props;
        ...
        >
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div className="flex flex-col-reverse items-start justify-end w-full gap-3 xl:flex-row xl:items-center xl:gap-5">
                    ...
                    <MoreOptions>
                        <button className='p-2 w-full text-left hover:bg-gray-100 dark:hover:bg-gray-800' onClick={handleEdit}>Edit</button>
                        <button className='p-2 w-full text-left hover:bg-gray-100 dark:hover:bg-gray-800' onClick={() => setDeleteModal(true)}>Delete</button>
                    </MoreOptions>
