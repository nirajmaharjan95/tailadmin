...
import { CreateTaskPayload, TaskType, UpdateTaskPayload } from "../types/task.type"
    ...
    const onSubmit = async (data: CreateTaskPayload) => {
        try {
            if (isEditing && editTask) {
                const payload: UpdateTaskPayload = { ...data, id: editTask.id };
        ...
        <div className="no-scrollbar relative w-full overflow-y-auto">
            <div className="px-2">
                ...
                <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                    {isEditing ? "Update the details of your task below" : "Effortlessly manage your to-do list: add a new task"}
                </p>
            </div>
